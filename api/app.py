...
model_bert = tf.keras.models.load_model(('toxicity_detector.h5'),custom_objects={'TFBertMainLayer':transformers.TFBertModel},compile=False)
tokenizer_bert = transformers.BertTokenizer.from_pretrained("bert-base-uncased")

model_bart = BartForConditionalGeneration.from_pretrained("BART_detox")
tokenizer_bart = AutoTokenizer.from_pretrained("BART_detox")
